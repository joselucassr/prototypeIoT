...
INSERT INTO `users` (`id`, `nome_empresa`, `cnpj`, `email_empresa`, `telefone_1_empresa`, `telefone_2_empresa`, `cidade`, `estado`, `cep`, `nome_usuario`, `cpf`, `email_usuario`, `telefone_usuario`, `celular_usuario`, `genero`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Jeni Enterprise', '99999999996', 'jeni@empresa.com', '6191111111', '6191111111', 'Brasília', 'DF', '99999999', 'Zé', '9999999999', 'joselucasrs@gmail.com', '6199999999', '6199999999', 1, '$2y$12$58VeD2qfy9v3h2kwn24/fu0OzOCPo0SlRXTVxZIY5oTQIEv4elPPO', 'Ob8VRGdRRPNVLnycg1oupFq1awfDRDa3QDnbOfXt8sdd17dvYdMaII94THn2', '2018-11-26 18:37:31', '2018-12-05 19:46:55'),
(2, 'Apresentar', '78.907.668/9096-66', 'email@apresentar.com', '(61) 9999-8888', '(61) 97777-3333', 'Brasília', 'DF', '70778-887', 'Eliel', '888.899.997-66', 'eliel@apresentar.com', '(61) 9852-5535', '(61) 95233-5852', 1, '$2y$10$dTUNfuupP5nSpYHxJ1Dg7.4VW7rRxkU.VZxuYCG/d5RjYAAXsgOyq', 'hvVMQv21DKOUwZhSf2p4AursreJF2i0XUpX65XF3K3t50v35UNuxUxT5X79j', '2018-11-28 23:19:42', '2018-11-28 23:19:42');
...
--
ALTER TABLE `sensors`
  MODIFY `id` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6656514643;
--
